...
echo "  5. First profile:   scripts/profiling/run_profile.sh --nsys executor/program_artifacts/rust/ethrex.elf --private-input executor/tests/ethrex_5_transfers.bin"
