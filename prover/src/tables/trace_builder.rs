...
impl Traces {
    ...
    pub fn from_elf_and_logs(
        ...
        // --- Flush: CPU ops + commit + page + memw_aligned + padding bitwise ---
        // bitwise_ops was populated during Phase 2 (CPU, LOAD, COMMIT lookups)
        // plus page IS_BYTE, memw_aligned, and padding IS_BYTE — flush all of them now.
        ...
        // --- Generate MEMW + MEMW_ALIGNED traces + drop ops ---
