...
pub const DEFAULT_PAGE_SIZE: usize = 1 << 23;
...
pub(crate) fn static_zero_page_commitment(blowup_factor: u8) -> Option<Commitment> {
    match blowup_factor {
        2 => Some([
            0x9c, 0xc9, 0xd5, 0x25, 0x4f, 0xac, 0x50, 0xed, 0xe2, 0x94, 0x44, 0x68, 0x0e, 0xf8,
            0xc5, 0xb1, 0x87, 0x62, 0xc7, 0x95, 0x1a, 0x6e, 0x9e, 0xd3, 0x91, 0x8a, 0x8a, 0x05,
            0x68, 0x6c, 0x88, 0xe5,
        ]),
        4 => Some([
            0x1e, 0xf0, 0x6a, 0xdf, 0x15, 0x55, 0x07, 0x18, 0xa4, 0x8f, 0x25, 0xd2, 0x85, 0xf2,
            0x1a, 0x7d, 0x49, 0x50, 0xfd, 0x22, 0x51, 0xea, 0x2a, 0x4a, 0x5f, 0x25, 0xfd, 0xfb,
            0x61, 0x5a, 0x07, 0xc7,
        ]),
        8 => Some([
            0xab, 0xcf, 0x3b, 0x11, 0x70, 0xde, 0x79, 0x14, 0x98, 0xc0, 0xd0, 0x71, 0x43, 0xe1,
            0xbe, 0x1c, 0x25, 0xd1, 0x95, 0x3b, 0x09, 0xa2, 0x5e, 0x9a, 0x58, 0xbc, 0xb8, 0x2d,
            0xaf, 0x84, 0x5b, 0x22,
        ]),
        _ => None,
    }
