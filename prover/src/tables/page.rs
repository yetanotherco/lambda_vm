...
pub(crate) fn static_zero_page_commitment(blowup_factor: u8) -> Option<Commitment> {
    match blowup_factor {
        2 => Some([
            0x20, 0x9e, 0x98, 0x09, 0x9f, 0xbf, 0x52, 0xeb, 0x25, 0x2b, 0x98, 0x43, 0xf1, 0xed,
            0xef, 0xd9, 0xd5, 0xbf, 0x20, 0x87, 0x47, 0x19, 0xb1, 0x44, 0xc1, 0x5d, 0xbd, 0xea,
            0x6a, 0xfb, 0xda, 0x6b,
        ]),
        4 => Some([
            0xd6, 0x93, 0x7f, 0xb4, 0xb0, 0x03, 0xc4, 0xfb, 0x31, 0xd7, 0x49, 0x17, 0xf9, 0x1a,
            0xe4, 0xac, 0x85, 0x0b, 0x71, 0x3f, 0xb5, 0x63, 0x8f, 0x60, 0x6f, 0x67, 0xd9, 0x28,
            0x29, 0x84, 0x43, 0x5d,
        ]),
        8 => Some([
            0xf5, 0x3c, 0x76, 0xd2, 0x50, 0xfb, 0x59, 0xb8, 0x43, 0x82, 0x97, 0x69, 0xcd, 0x02,
            0xf9, 0x62, 0xe3, 0xef, 0x31, 0xdd, 0x15, 0xb9, 0xd4, 0x53, 0xf7, 0x3e, 0x75, 0xf3,
            0x5c, 0x11, 0xfd, 0x72,
        ]),
        _ => None,
    }
...
pub(crate) fn static_private_page_commitment(blowup_factor: u8) -> Option<Commitment> {
    match blowup_factor {
        2 => Some([
            0x37, 0x54, 0x07, 0x1f, 0xde, 0x7d, 0x80, 0x58, 0x1e, 0xab, 0x88, 0xaf, 0x92, 0x1c,
            0x9e, 0x99, 0x08, 0xcf, 0x6c, 0x99, 0x3d, 0x97, 0x95, 0xdc, 0x24, 0xfd, 0xcc, 0x53,
            0x0f, 0x28, 0xd0, 0xb3,
        ]),
        4 => Some([
            0xdc, 0xf3, 0x1e, 0x25, 0x9a, 0x24, 0x29, 0x85, 0x49, 0xbe, 0xd6, 0x5b, 0xb7, 0x9c,
            0x9f, 0x2f, 0x4f, 0x85, 0xd5, 0x43, 0x02, 0x15, 0x27, 0x7d, 0xef, 0x51, 0x9a, 0x96,
            0x6c, 0x4a, 0x4f, 0xbc,
        ]),
        8 => Some([
            0xe3, 0x41, 0x3b, 0x17, 0x31, 0x88, 0xb9, 0x0b, 0x79, 0xbb, 0x46, 0xfd, 0xe4, 0x3a,
            0xf6, 0xe6, 0x6d, 0x03, 0xe7, 0x7b, 0x36, 0x99, 0xb3, 0x7e, 0x35, 0xca, 0x61, 0x08,
            0x39, 0x62, 0x0c, 0xcd,
        ]),
        _ => None,
    }
