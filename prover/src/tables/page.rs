...
pub(crate) fn static_zero_page_commitment(blowup_factor: u8) -> Option<Commitment> {
    match blowup_factor {
        2 => Some([
            0x17, 0xca, 0x82, 0xd0, 0x53, 0x18, 0x0e, 0x72, 0x0d, 0xa6, 0x33, 0x27, 0xe8, 0x64,
            0xb4, 0x61, 0xe5, 0xfa, 0x96, 0x65, 0x09, 0xa3, 0x41, 0x09, 0xff, 0x3f, 0x62, 0x81,
            0x3a, 0xe8, 0x8c, 0x62,
        ]),
        4 => Some([
            0x7a, 0x23, 0x4c, 0x3d, 0x8c, 0x24, 0xcc, 0x88, 0x6c, 0xb6, 0xe4, 0xd5, 0xc9, 0xe3,
            0xf0, 0x4e, 0x87, 0x56, 0xb5, 0xe0, 0x17, 0x98, 0x45, 0xd3, 0x7c, 0x3e, 0x4d, 0xcc,
            0x08, 0x66, 0xc3, 0xab,
        ]),
        8 => Some([
            0x9d, 0xc4, 0x23, 0xf5, 0xad, 0x9c, 0x10, 0x12, 0xc5, 0x5d, 0xa5, 0x9f, 0xd4, 0x0e,
            0x55, 0x99, 0x0a, 0x9a, 0x3c, 0x3a, 0x77, 0xd7, 0x27, 0xfb, 0xbe, 0xd1, 0xc8, 0x5a,
            0xb0, 0x45, 0x62, 0xf6,
        ]),
        _ => None,
    }
...
pub(crate) fn static_private_page_commitment(blowup_factor: u8) -> Option<Commitment> {
    match blowup_factor {
        2 => Some([
            0xbc, 0x98, 0x15, 0x92, 0xb7, 0xfb, 0x9b, 0x50, 0x5a, 0xfb, 0xa7, 0x48, 0x40, 0x0a,
            0x67, 0xb9, 0x56, 0x2d, 0x54, 0x6e, 0x56, 0xb0, 0x32, 0xf1, 0x19, 0x57, 0x86, 0x36,
            0x30, 0xa0, 0x76, 0x42,
        ]),
        4 => Some([
            0x1a, 0x60, 0x17, 0xe1, 0x43, 0x1b, 0x15, 0xe5, 0xe8, 0x33, 0x39, 0xae, 0xc6, 0x6a,
            0x62, 0x72, 0x2b, 0xd0, 0x95, 0xbe, 0xb3, 0x05, 0x06, 0x9f, 0x72, 0x32, 0xea, 0xac,
            0x07, 0x0a, 0xfa, 0x6f,
        ]),
        8 => Some([
            0xb5, 0x27, 0xbd, 0x0d, 0xa1, 0x14, 0xfe, 0xe0, 0x45, 0xe6, 0x32, 0xb7, 0x86, 0xf0,
            0x68, 0x26, 0x05, 0x19, 0xa1, 0x57, 0x46, 0x24, 0xc3, 0x0d, 0x2f, 0xdd, 0x16, 0xe3,
            0x72, 0x3a, 0xbf, 0x3b,
        ]),
        _ => None,
    }
