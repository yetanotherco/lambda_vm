...
impl CpuOperation {
    ...
    pub fn collect_byte_check_ops(&self) -> Vec<super::bitwise::BitwiseOperation> {
        ...
        // Extract all 27 byte values
        let rs1 = self.decode.rs1;
        let rs2 = self.decode.rs2;
        let rd = self.decode.rd;
        let arg1_bytes: [u8; 8] = std::array::from_fn(|i| ((arg1 >> (i * 8)) & 0xFF) as u8);
        ...
        let pairs: [(u8, u8); 13] = [
            (rs1, rs2),
            (rd, arg1_bytes[0]),
            (arg1_bytes[1], arg1_bytes[2]),
            (arg1_bytes[3], arg1_bytes[4]),
            (arg1_bytes[5], arg1_bytes[6]),
            (arg1_bytes[7], arg2_bytes[0]),
            (arg2_bytes[1], arg2_bytes[2]),
            (arg2_bytes[3], arg2_bytes[4]),
            (arg2_bytes[5], arg2_bytes[6]),
            (arg2_bytes[7], res_bytes[0]),
            (res_bytes[1], res_bytes[2]),
            (res_bytes[3], res_bytes[4]),
            (res_bytes[5], res_bytes[6]),
        ];
...
pub fn bus_interactions() -> Vec<BusInteraction> {
    ...
    let byte_pairs: [(usize, usize); 13] = [
        (cols::RS1, cols::RS2),
        (cols::RD, cols::ARG1[0]),
        (cols::ARG1[1], cols::ARG1[2]),
        (cols::ARG1[3], cols::ARG1[4]),
        (cols::ARG1[5], cols::ARG1[6]),
        (cols::ARG1[7], cols::ARG2[0]),
        (cols::ARG2[1], cols::ARG2[2]),
        (cols::ARG2[3], cols::ARG2[4]),
        (cols::ARG2[5], cols::ARG2[6]),
        (cols::ARG2[7], cols::RES[0]),
        (cols::RES[1], cols::RES[2]),
        (cols::RES[3], cols::RES[4]),
        (cols::RES[5], cols::RES[6]),
    ];
