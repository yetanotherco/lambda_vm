...
// =========================================================================
// Column indices (666 columns; keep in sync with NUM_COLUMNS below)
// =========================================================================

pub mod cols {
    pub const TIMESTAMP: usize = 0; // timestamp: Word (1 column)
    ...
    pub const K: usize = 71; // Bit[256] — scalar bits, k[0] is LSB
    pub const LEN_K: usize = 327; // Byte
    pub const XG: usize = 328; // U256BL (32)
    pub const YG: usize = 360; // U256BL (32)
    pub const X2: usize = 392; // U256BL (32)
    pub const Q0: usize = 424; // U256BL (32)
    pub const C0: usize = 456; // BaseField[64]
    pub const Q1: usize = 520; // Byte[33]
    pub const C1: usize = 553; // BaseField[64]
    pub const XG_SUB_P: usize = 617; // U256HL (16 halfwords)
    pub const K_SUB_N: usize = 633; // U256HL (16 halfwords)
    pub const XR_SUB_P: usize = 649; // U256HL (16 halfwords)
    pub const MU: usize = 665;

    pub const NUM_COLUMNS: usize = 666;
...
pub fn bus_interactions() -> Vec<BusInteraction> {
    ...
    // ECALL receiver (mult = mu): [ts, syscall_lo32, syscall_hi32].
    ...
    for i in 0..256 {
        out.push(BusInteraction::receiver(
            ...
            vec![ts(), BusValue::constant(i as u64)],
        ));
    }
...
/// Builds the ECDAS bus tuple `[id, ts, accX(32), accY(32), genX(32), genY(32),
...
pub fn ecdas_tuple(
    ...
    let mut v = Vec::with_capacity(1 + 1 + 4 * 32 + 2);
