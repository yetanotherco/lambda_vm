...
fn test_verify_rejects_tampered_public_output() {
    ...
    let verified = crate::verify_with_options(&tampered_proof, &elf_bytes, &proof_options, None, None)
...
fn test_verify_rejects_zero_table_counts() {
    ...
    let result = crate::verify_with_options(&tampered_proof, &elf_bytes, &proof_options, None, None);
