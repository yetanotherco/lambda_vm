...
fn test_prove_elfs_sha256_overlap_and_tampering() {
    ...
    for target in 0..5 {
        ...
        let (table, col) = match target {
            0 => (&mut traces.sha256, crate::tables::sha256::OUT),
            1 => (&mut traces.sha256, crate::tables::sha256::PTR),
            2 => (&mut traces.sha256_round, crate::tables::sha256_round::K),
            3 => (&mut traces.sha256_schedule, 3),
            _ => (&mut traces.sha256_rotxor, 32),
        };
