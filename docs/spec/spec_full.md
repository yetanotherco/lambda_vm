...
| `rv2` | `DWordBL` | The value of register `rs2` |
...
| `CPU-CR32.i` | i ∈ [0, 7] | `IS_BYTE[rv2[i]]` | 1 |
| `CPU-CR33.i` | i ∈ [0, 7] | `IS_BYTE[arg1[i]]` | 1 |
| `CPU-CR34.i` | i ∈ [0, 7] | `IS_BYTE[arg2[i]]` | 1 |
| `CPU-CR35.i` | i ∈ [0, 7] | `IS_BYTE[res[i]]` | 1 |
...
| Tag | Range | Description | Multiplicity |
|-----|-------|-------------|--------------|
| `CPU-CA36` |  | ADD + LOAD + STORE ⇒ `ADD<res::DWordWL; arg1::DWordWL, arg2::DWordWL>` |  |
...
| Tag | Range | Description | Multiplicity |
|-----|-------|-------------|--------------|
| `CPU-CM47` |  | `MEMW[[(rv1::DWordWL)[0], rv1[2], 0, 0, 0, 0, 0, 0]; 1, 2 * rs1, [(rv1::DWordWL)[0], rv1[2], 0, 0, 0, 0, 0, 0], timestamp + 0::DWordWL, 1, 0, 0]` | read_register1 |
| `CPU-CM48.i` | i ∈ [0, 2] | `!read_register1` => `rv1[i]` = 0 |  |
| | | _polynomial:_ `(1 - read_register1) * rv1[i] = 0` | |
| `CPU-CM49` |  | `MEMW[[(rv2::DWordWL)[0], (rv2::DWordWL)[1], 0, 0, 0, 0, 0, 0]; 1, 2 * rs2, [(rv2::DWordWL)[0], (rv2::DWordWL)[1], 0, 0, 0, 0, 0, 0], timestamp + 1::DWordWL, 1, 0, 0]` | read_register2 |
| `CPU-CM50.i` | i ∈ [0, 7] | `!read_register2` => `rv2[i]` = 0 |  |
| | | _polynomial:_ `(1 - read_register2) * rv2[i] = 0` | |
| `CPU-CM51` |  | `MEMW[1, 2 * rd, [rvd[0], rvd[1], 0, 0, 0, 0, 0, 0], timestamp + 2::DWordWL, 1, 0, 0]` | write_register |
| `CPU-CM52` |  | `LOAD[rvd; 0, res, timestamp + 0::DWordWL, memory_2bytes, memory_4bytes, memory_8bytes, signed]` | LOAD |
| `CPU-CM53` |  | `MEMW[0, res, rv2::Byte[8], timestamp + 1::DWordWL, memory_2bytes, memory_4bytes, memory_8bytes]` | STORE |
| `CPU-CM54` |  | `MEMW[[pc[0], pc[1], 0, 0, 0, 0, 0, 0]; 1, 2 * 255, [next_pc[0], next_pc[1], 0, 0, 0, 0, 0, 0], timestamp + 1::DWordWL, 1, 0, 0]` | 1 - pad |
...
| `CPU-CE61` | `MSB8[arg2_sign_bit; rv2[3]]` | word_instr |
| `CPU-CE62` | `arg2[:4]` = (1 - `STORE` - `LOAD`) dot `rv2[:4]` + (1 - `BEQ` - `BLT`) dot `imm[0]` |  |
| | _polynomial:_ `(arg2::DWordWL)[0] - (1 - STORE - LOAD) * (rv2::DWordWL)[0] - (1 - BEQ - BLT) * imm[0] = 0` | |
| `CPU-CE63` | `arg2[4:]` = (1 - `STORE` - `LOAD`) dot ((1 - `word_instr`) dot `rv2[4:]` + `signed` dot `arg2_sign_bit` dot (2^(32) - 1)) + (1 - `BEQ` - `BLT`) dot `imm[1]` |  |
| | _polynomial:_ `(arg2::DWordWL)[1] - (1 - STORE - LOAD) * (1 - word_instr) * (rv2::DWordWL)[1] - (1 - STORE - LOAD) * signed * arg2_sign_bit * (2^32 - 1) - (1 - BEQ - BLT) * imm[1] = 0` | |
