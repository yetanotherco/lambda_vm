...
Formal specification of the Lambda VM. Covers the per-chip AIR constraints (CPU, decode, ALU, bitwise, branch, memory, MEMW, LOAD, MUL, DVRM, shift, LT, HALT, COMMIT, …), the memory argument, and the LogUp lookup framework that links the tables.
