...
The initialization and finalization schemes together ensure both that the necessary preconditions
for the lookup system are satisfied, and that the program is executed with the correct
