...
mod tests {
    ...
    fn test_verifier_multifold_matches_prover() {
        use super::{compute_coset_twiddles_inv, fold_evaluations_in_place, update_twiddles_in_place};
        ...
        let evals: Vec<GFE> = (0..domain_size).map(|i| GFE::from((i * 3 + 5) as u64)).collect();
        ...
        for group_idx in 0..domain_size / group_size {
            ...
            for _ in 0..log_arity {
                ...
                let sub_root = GoldilocksField::get_primitive_root_of_unity(sub_domain_log_size as u64).unwrap();
