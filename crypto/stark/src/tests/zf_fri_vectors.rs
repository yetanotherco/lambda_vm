//! The exported S3 vectors (FRI.md §10 (a)–(d)) under Keccak and Blake3 are
...
use crate::fri::vectors::{
    VectorFile, check_or_write, group_fold_json, leaf_digests_json, proof_vectors, schedules_json,
};
