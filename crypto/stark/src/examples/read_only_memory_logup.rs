    ...
    FieldElement<F>: ByteConversion,
{
    ...
    fn build_auxiliary_trace(
        ...
        // Batch-invert all fingerprints at once (2N multiplications + 1 inversion
        // instead of 2N individual inversions).
        ...
        let mut sorted_fingerprints: Vec<_> = (0..trace_len)
            ...
            .collect();
        FieldElement::inplace_batch_inverse(&mut unsorted_fingerprints).unwrap();
        FieldElement::inplace_batch_inverse(&mut sorted_fingerprints).unwrap();
