...
/// Single-body [`ConstraintSet`] for [`Fibonacci2ColsShifted`]: the same
/// constraints as `ShiftedFibTransition1` + `ShiftedFibTransition2`, written
/// once against the [`ConstraintBuilder`].
