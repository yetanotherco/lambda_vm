...
|---|---|---|---|
| fib_iterative_1M (median of 5) | **17.641 s** | **13.460 s** | **1.31× (24% faster)** |
| fib_iterative_4M (median of 3) | **41.401 s** | **35.139 s** | **1.18× (15% faster)** |

Correctness: all 28 math-cuda parity tests + 121 stark cuda tests pass.
