...
### End-to-end speedup (with GPU Keccak-256 Merkle leaf hashing + fused tree build + R2-commit tree)

| Program | CPU rayon (46 cores) | CUDA (median of 5×5) | Delta |
|---|---|---|---|
| fib_iterative_1M | **18.269 s** | **13.023 s** | **1.40× (28.7% faster)** |
| fib_iterative_4M |               | **32.094 s** | (range check) |
