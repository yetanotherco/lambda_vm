...
const MEMW_REGISTER_TRACE_PTX: &str =
    include_str!(concat!(env!("OUT_DIR"), "/memw_register_trace.ptx"));
...
const ECSM_TRACE_PTX: &str = include_str!(concat!(env!("OUT_DIR"), "/ecsm_trace.ptx"));
...
pub struct Backend {
    ...
    // decode_trace.ptx
    pub generate_decode_trace_rows: CudaFunction,
    ...
    // store_trace.ptx
    pub generate_store_trace_rows: CudaFunction,

    // bytewise_trace.ptx
    pub generate_bytewise_trace_rows: CudaFunction,
    ...
    pub generate_memw_register_trace_rows: CudaFunction,

    // lt_trace.ptx
    pub generate_lt_trace_rows: CudaFunction,

    // mul_trace.ptx
    pub generate_mul_trace_rows: CudaFunction,
    ...
    // cpu32_trace.ptx
    pub generate_cpu32_trace_rows: CudaFunction,

    // dvrm_trace.ptx
    pub generate_dvrm_trace_rows: CudaFunction,
    ...
    // ecsm_trace.ptx
    pub generate_ecsm_trace_rows: CudaFunction,
...
impl Backend {
    fn init() -> Result<Self> {
        ...
        let memw_register_trace = ctx.load_module(Ptx::from_src(MEMW_REGISTER_TRACE_PTX))?;
        ...
        let ecsm_trace = ctx.load_module(Ptx::from_src(ECSM_TRACE_PTX))?;
        ...
        Ok(Self {
            ...
            generate_decode_trace_rows: decode_trace
            ...
            generate_store_trace_rows: store_trace.load_function("generate_store_trace_rows")?,
            ...
            generate_memw_register_trace_rows: memw_register_trace
                .load_function("generate_memw_register_trace_rows")?,
            ...
            generate_ecsm_trace_rows: ecsm_trace.load_function("generate_ecsm_trace_rows")?,
