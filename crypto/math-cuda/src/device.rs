...
pub struct Backend {
    ...
    pub keccak_f1600_batch: CudaFunction,
    ...
    pub commit_fill: CudaFunction,
    pub keccak_table_fill: CudaFunction,
    pub ecdas_fill: CudaFunction,
    pub ecdas_carries: CudaFunction,
    pub ecsm_fill: CudaFunction,
    pub keccak_rnd_fill: CudaFunction,
    ...
    pub branch_fill: CudaFunction,
    pub cpu32_fill: CudaFunction,
    pub memw_fill: CudaFunction,
    pub memw_register_fill: CudaFunction,
    pub page_fill_snapshot: CudaFunction,

    // trace_walk.ptx (on-GPU register memory-model walk)
    pub reg_access_counts: CudaFunction,
    pub reg_access_scatter: CudaFunction,
    pub reg_ecall_op_counts: CudaFunction,
    pub reg_access_counts_ecall: CudaFunction,
    pub reg_access_scatter_ecall: CudaFunction,
    pub rowindex_to_emits: CudaFunction,
    pub memacc_counts: CudaFunction,
    pub memacc_emit: CudaFunction,
    pub mem_ecall_byte_counts: CudaFunction,
    pub memacc_counts_ecall: CudaFunction,
    pub memacc_emit_ecall: CudaFunction,
    pub image_lookup: CudaFunction,
    ...
    // trace_walk.ptx (memory walk — radix sort by 64-bit address, Phase 2)
    pub memw_gather: CudaFunction,
    pub ecall_oldstate_gather: CudaFunction,
    pub memw_classify: CudaFunction,
    pub memw_pack: CudaFunction,
    pub radix_iota: CudaFunction,
    pub radix_seg_hist: CudaFunction,
    pub radix_seg_scatter: CudaFunction,
    pub mem_link: CudaFunction,
    pub mem_final_flag: CudaFunction,
    pub mem_final_gather: CudaFunction,
    pub reg_final_seed: CudaFunction,
    pub reg_final_maxts: CudaFunction,
    pub reg_final_gather: CudaFunction,
    pub reg_x254_scan: CudaFunction,
    // trace_walk.ptx (memw→lt pair generation — LT-resident-table)
    pub memw_lt_widths: CudaFunction,
    pub memw_lt_emit_aligned: CudaFunction,
    pub memw_lt_emit_general: CudaFunction,
    // trace_walk.ptx (device dedup — sort by op key + segmented reduce)
    pub dedup_seg_start: CudaFunction,
    pub dedup_emit: CudaFunction,
    pub dedup_emit2: CudaFunction,
    pub dedup_seg_start4: CudaFunction,
    pub dedup_emit4: CudaFunction,
    ...
    pub bitwise_hist_cpu_ops_packed: CudaFunction,
    pub bitwise_hist_memw_reg: CudaFunction,
    pub bitwise_hist_memw_reg_masked: CudaFunction,
    pub bitwise_hist_memw_reg_routed: CudaFunction,
    pub bitwise_hist_memw_aligned: CudaFunction,
    pub bitwise_hist_page: CudaFunction,
    pub bitwise_hist_page_snapshot: CudaFunction,
    pub bitwise_hist_opvec_packed: CudaFunction,
    pub bitwise_hist_branch_load_packed: CudaFunction,
    pub bitwise_hist_cpu32_packed: CudaFunction,
    pub bitwise_hist_shift_packed: CudaFunction,
    pub bitwise_hist_mul_perop_packed: CudaFunction,
    pub bitwise_hist_dvrm_perop_packed: CudaFunction,
    pub bitwise_hist_lt: CudaFunction,
    pub bitwise_hist_store: CudaFunction,
    pub bitwise_hist_bytewise: CudaFunction,
    pub bitwise_hist_eq: CudaFunction,
    pub bitwise_hist_load: CudaFunction,
    pub bitwise_hist_cpu32: CudaFunction,
    pub bitwise_hist_branch: CudaFunction,
    pub bitwise_hist_shift: CudaFunction,
    pub bitwise_hist_mul_perop: CudaFunction,
    pub bitwise_hist_dvrm_perop: CudaFunction,
    pub bitwise_hist_reduce: CudaFunction,
    // trace_ops.ptx (device CpuOperation builder — Phase 0)
    pub build_cpu_ops: CudaFunction,
    // trace_ops.ptx (state-free ALU chip-op classify/extract — Phase 3)
    pub chipop_alu_route: CudaFunction,
    pub chipop_gather: CudaFunction,
    pub chipop_branch_store_route: CudaFunction,
    pub chipop_gather4: CudaFunction,
    pub cpu32_route: CudaFunction,
    pub build_cpu32_ops: CudaFunction,
    pub load_route: CudaFunction,
    pub build_load_ops: CudaFunction,
    pub store_route: CudaFunction,
    pub build_store_ops: CudaFunction,
    pub lt_key_gather: CudaFunction,
    pub dvrm_lt_key_gather: CudaFunction,
    pub lt_memw_key_write: CudaFunction,
    pub eq_key_gather: CudaFunction,
    pub bytewise_key_gather: CudaFunction,
    pub dedup_pack_abf: CudaFunction,
    pub dedup_pack_abf2: CudaFunction,
    pub mul_key_gather: CudaFunction,
    pub mul_dvrm_key_gather: CudaFunction,
    pub dvrm_key_gather: CudaFunction,
    pub build_shift_ops: CudaFunction,
    pub cpu32_shift_route: CudaFunction,
    pub cpu32_shift_ops: CudaFunction,
    pub cpu32_mul_route: CudaFunction,
    pub cpu32_dvrm_route: CudaFunction,
    pub cpu32_mul_ops: CudaFunction,
    pub cpu32_dvrm_ops: CudaFunction,
    pub cpu32_dvrm_mul_key_gather: CudaFunction,
    pub branch_key_gather: CudaFunction,
    pub branch_pack: CudaFunction,
...
impl Backend {
    fn init() -> Result<Self> {
        ...
        Ok(Self {
            ...
            keccak_f1600_batch: keccak.load_function("keccak_f1600_batch")?,
            ...
            commit_fill: trace_cpu.load_function("commit_fill")?,
            keccak_table_fill: trace_cpu.load_function("keccak_table_fill")?,
            ecdas_fill: trace_cpu.load_function("ecdas_fill")?,
            ecdas_carries: trace_cpu.load_function("ecdas_carries")?,
            ecsm_fill: trace_cpu.load_function("ecsm_fill")?,
            keccak_rnd_fill: trace_cpu.load_function("keccak_rnd_fill")?,
            ...
            branch_fill: trace_cpu.load_function("branch_fill")?,
            ...
            page_fill_snapshot: trace_cpu.load_function("page_fill_snapshot")?,
            reg_access_counts: trace_walk.load_function("reg_access_counts")?,
            reg_access_scatter: trace_walk.load_function("reg_access_scatter")?,
            reg_ecall_op_counts: trace_walk.load_function("reg_ecall_op_counts")?,
            reg_access_counts_ecall: trace_walk.load_function("reg_access_counts_ecall")?,
            reg_access_scatter_ecall: trace_walk.load_function("reg_access_scatter_ecall")?,
            rowindex_to_emits: trace_walk.load_function("rowindex_to_emits")?,
            memacc_counts: trace_walk.load_function("memacc_counts")?,
            memacc_emit: trace_walk.load_function("memacc_emit")?,
            mem_ecall_byte_counts: trace_walk.load_function("mem_ecall_byte_counts")?,
            memacc_counts_ecall: trace_walk.load_function("memacc_counts_ecall")?,
            memacc_emit_ecall: trace_walk.load_function("memacc_emit_ecall")?,
            image_lookup: trace_walk.load_function("image_lookup")?,
            ...
            memw_gather: trace_walk.load_function("memw_gather")?,
            ecall_oldstate_gather: trace_walk.load_function("ecall_oldstate_gather")?,
            memw_classify: trace_walk.load_function("memw_classify")?,
            memw_pack: trace_walk.load_function("memw_pack")?,
            radix_iota: trace_walk.load_function("radix_iota")?,
            radix_seg_hist: trace_walk.load_function("radix_seg_hist")?,
            radix_seg_scatter: trace_walk.load_function("radix_seg_scatter")?,
            mem_link: trace_walk.load_function("mem_link")?,
            mem_final_flag: trace_walk.load_function("mem_final_flag")?,
            mem_final_gather: trace_walk.load_function("mem_final_gather")?,
            reg_final_seed: trace_walk.load_function("reg_final_seed")?,
            reg_final_maxts: trace_walk.load_function("reg_final_maxts")?,
            reg_final_gather: trace_walk.load_function("reg_final_gather")?,
            reg_x254_scan: trace_walk.load_function("reg_x254_scan")?,
            memw_lt_widths: trace_walk.load_function("memw_lt_widths")?,
            memw_lt_emit_aligned: trace_walk.load_function("memw_lt_emit_aligned")?,
            memw_lt_emit_general: trace_walk.load_function("memw_lt_emit_general")?,
            dedup_seg_start: trace_walk.load_function("dedup_seg_start")?,
            dedup_emit: trace_walk.load_function("dedup_emit")?,
            dedup_emit2: trace_walk.load_function("dedup_emit2")?,
            dedup_seg_start4: trace_walk.load_function("dedup_seg_start4")?,
            dedup_emit4: trace_walk.load_function("dedup_emit4")?,
            ...
            bitwise_hist_cpu_ops_packed: bitwise_hist
                .load_function("bitwise_hist_cpu_ops_packed")?,
            bitwise_hist_memw_reg: bitwise_hist.load_function("bitwise_hist_memw_reg")?,
            bitwise_hist_memw_reg_masked: bitwise_hist
                .load_function("bitwise_hist_memw_reg_masked")?,
            bitwise_hist_memw_reg_routed: bitwise_hist
                .load_function("bitwise_hist_memw_reg_routed")?,
            bitwise_hist_memw_aligned: bitwise_hist
                .load_function("bitwise_hist_memw_aligned")?,
            bitwise_hist_page: bitwise_hist.load_function("bitwise_hist_page")?,
            bitwise_hist_page_snapshot: bitwise_hist
                .load_function("bitwise_hist_page_snapshot")?,
            bitwise_hist_opvec_packed: bitwise_hist
                .load_function("bitwise_hist_opvec_packed")?,
            bitwise_hist_branch_load_packed: bitwise_hist
                .load_function("bitwise_hist_branch_load_packed")?,
            bitwise_hist_cpu32_packed: bitwise_hist
                .load_function("bitwise_hist_cpu32_packed")?,
            bitwise_hist_shift_packed: bitwise_hist
                .load_function("bitwise_hist_shift_packed")?,
            bitwise_hist_mul_perop_packed: bitwise_hist
                .load_function("bitwise_hist_mul_perop_packed")?,
            bitwise_hist_dvrm_perop_packed: bitwise_hist
                .load_function("bitwise_hist_dvrm_perop_packed")?,
            bitwise_hist_lt: bitwise_hist.load_function("bitwise_hist_lt")?,
            bitwise_hist_store: bitwise_hist.load_function("bitwise_hist_store")?,
            bitwise_hist_bytewise: bitwise_hist.load_function("bitwise_hist_bytewise")?,
            bitwise_hist_eq: bitwise_hist.load_function("bitwise_hist_eq")?,
            bitwise_hist_load: bitwise_hist.load_function("bitwise_hist_load")?,
            bitwise_hist_cpu32: bitwise_hist.load_function("bitwise_hist_cpu32")?,
            bitwise_hist_branch: bitwise_hist.load_function("bitwise_hist_branch")?,
            bitwise_hist_shift: bitwise_hist.load_function("bitwise_hist_shift")?,
            bitwise_hist_mul_perop: bitwise_hist.load_function("bitwise_hist_mul_perop")?,
            bitwise_hist_dvrm_perop: bitwise_hist.load_function("bitwise_hist_dvrm_perop")?,
            bitwise_hist_reduce: bitwise_hist.load_function("bitwise_hist_reduce")?,
            build_cpu_ops: trace_ops.load_function("build_cpu_ops")?,
            chipop_alu_route: trace_ops.load_function("chipop_alu_route")?,
            chipop_gather: trace_ops.load_function("chipop_gather")?,
            chipop_branch_store_route: trace_ops
                .load_function("chipop_branch_store_route")?,
            chipop_gather4: trace_ops.load_function("chipop_gather4")?,
            cpu32_route: trace_ops.load_function("cpu32_route")?,
            build_cpu32_ops: trace_ops.load_function("build_cpu32_ops")?,
            load_route: trace_ops.load_function("load_route")?,
            build_load_ops: trace_ops.load_function("build_load_ops")?,
            store_route: trace_ops.load_function("store_route")?,
            build_store_ops: trace_ops.load_function("build_store_ops")?,
            lt_key_gather: trace_ops.load_function("lt_key_gather")?,
            dvrm_lt_key_gather: trace_ops.load_function("dvrm_lt_key_gather")?,
            lt_memw_key_write: trace_ops.load_function("lt_memw_key_write")?,
            eq_key_gather: trace_ops.load_function("eq_key_gather")?,
            bytewise_key_gather: trace_ops.load_function("bytewise_key_gather")?,
            dedup_pack_abf: trace_ops.load_function("dedup_pack_abf")?,
            dedup_pack_abf2: trace_ops.load_function("dedup_pack_abf2")?,
            mul_key_gather: trace_ops.load_function("mul_key_gather")?,
            mul_dvrm_key_gather: trace_ops.load_function("mul_dvrm_key_gather")?,
            dvrm_key_gather: trace_ops.load_function("dvrm_key_gather")?,
            build_shift_ops: trace_ops.load_function("build_shift_ops")?,
            cpu32_shift_route: trace_ops.load_function("cpu32_shift_route")?,
            cpu32_shift_ops: trace_ops.load_function("cpu32_shift_ops")?,
            cpu32_mul_route: trace_ops.load_function("cpu32_mul_route")?,
            cpu32_dvrm_route: trace_ops.load_function("cpu32_dvrm_route")?,
            cpu32_mul_ops: trace_ops.load_function("cpu32_mul_ops")?,
            cpu32_dvrm_ops: trace_ops.load_function("cpu32_dvrm_ops")?,
            cpu32_dvrm_mul_key_gather: trace_ops
                .load_function("cpu32_dvrm_mul_key_gather")?,
            branch_key_gather: trace_ops.load_function("branch_key_gather")?,
            branch_pack: trace_ops.load_function("branch_pack")?,
