...
// value at that point (base for main-trace columns, ext3 for aux / composition
...
// `vanishing * n_inv * g_n_inv` once per column on the host — cheap, and
// keeping it out of the kernel means we don't need to carry yet another
