use super::{
    curve::BLS12381Curve,
    field_extension::{
        BLS12381PrimeField, Degree2ExtensionField, Degree4ExtensionField, Degree12ExtensionField,
...
pub const GAMMA_15: Fp2E = Fp2E::const_from_raw([
    FpE::from_hex_unchecked(
        "5B2CFD9013A5FD8DF47FA6B48B1E045F39816240C0B8FEE8BEADF4D8E9C0566C63A3E6E257F87329B18FAE980078116",
    ),
    FpE::from_hex_unchecked(
...
pub fn double_accumulate_line(
    ...
    let two_inv = FieldElement::<Degree2ExtensionField>::new_base(
