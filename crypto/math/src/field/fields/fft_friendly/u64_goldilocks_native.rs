...
//!
//! # Performance vs Montgomery
//!
//! Benchmarks on Apple M1 show native consistently outperforms Montgomery:
//!
//! | Operation | Native vs Montgomery | Notes |
//! |-----------|---------------------|-------|
//! | mul       | ~19% faster         | LLVM generates optimal MUL+UMULH |
//! | square    | ~30% faster         | Benefits from direct reduction |
//! | inv       | ~43% faster (batch) | Addition chain + fast mul/square |
//! | add/sub   | ~comparable         | LLVM optimizes well |
//!
//! # Key Properties
//!
