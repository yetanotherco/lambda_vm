...
//!
//! These parameters are compatible with Plonky3/HorizenLabs implementations.
...
/// Poseidon2 configuration for Goldilocks with width 8
pub struct Poseidon2GoldilocksWidth8;
...
/// External round constants - initial 4 rounds (4 rounds × 8 values)
...
/// External round constants - terminal 4 rounds (4 rounds × 8 values)
...
/// Internal round constants (22 rounds × 1 value, applied to first element only)
