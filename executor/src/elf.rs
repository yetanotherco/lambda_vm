...
pub(crate) const EXECUTABLE_HEADER_SIZE: usize = 64; // 64-bit ELF header is 64 bytes
pub(crate) const PROGRAM_HEADER_SIZE: usize = 56; // 64-bit program header is 56 bytes
pub(crate) const ELF_64_BIT: u8 = 2;
pub(crate) const ELF_LITTLE_ENDIAN: u8 = 1;
pub(crate) const ELF_CURRENT_VERSION: u8 = 1;
