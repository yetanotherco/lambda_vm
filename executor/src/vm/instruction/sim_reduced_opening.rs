...
use math::sim_ro::{ReducedOpeningQueryInput, ReducedOpeningRowInput};

/// Syscall number for `REDUCED_OPENING_ROW` (Level A) — `u64::MAX - 20`.
pub const REDUCED_OPENING_ROW_SYSCALL_NUMBER: u64 = u64::MAX - 20;
/// Syscall number for `REDUCED_OPENING_QUERY` (Level B) — `u64::MAX - 21`.
pub const REDUCED_OPENING_QUERY_SYSCALL_NUMBER: u64 = u64::MAX - 21;
